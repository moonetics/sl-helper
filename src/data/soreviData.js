...
const soreviRoleBlueprint = [
  ...
  { name: "Head of Support", color: "#2ECC71", hoist: true, mentionable: true },
...
const soreviChannelBlueprint = [
  {
    ...
    channels: [
      ...
      { type: "text", name: "self-roles", readOnly: true },
    ],
  },
  {
  ...
  },
  {
    name: "🧪 ｜ QA & PLAYTESTING",
    channels: [
      { type: "text", name: "sneak-peeks", readOnly: true },
  ...
  },
  {
    ...
    channels: [
      { type: "voice", name: "Dev Co-Working" },
